                ...
                VStack(spacing: 0) {
                    ...
                    HStack(spacing: 0) {
                        Button(action: {
                            ...
                            Text("Monthly")
                                .font(.system(size: 12, weight: .bold))
                                .foregroundColor(currentBilling == "monthly" ? Color(hex: "7900FF") : Color(hex: "505050"))
                                .frame(maxWidth: .infinity)
                                .padding(.vertical, 8)
                                .background(currentBilling == "monthly" ? Color.white : Color.clear)
                                .cornerRadius(999)
                                .shadow(color: currentBilling == "monthly" ? Color.black.opacity(0.05) : Color.clear, radius: 2, x: 0, y: 1)
                        }
                        ...
                        Button(action: {
                            ...
                            ZStack {
                                Text("Yearly")
                                    .font(.system(size: 12, weight: .bold))
                                    .foregroundColor(currentBilling == "yearly" ? Color(hex: "7900FF") : Color(hex: "505050"))
                                    .frame(maxWidth: .infinity)
                                    .padding(.vertical, 8)
                                    .background(currentBilling == "yearly" ? Color.white : Color.clear)
                                    .cornerRadius(999)
                                    .shadow(color: currentBilling == "yearly" ? Color.black.opacity(0.05) : Color.clear, radius: 2, x: 0, y: 1)
                    ...
                    // Tier Tabs
                    HStack(spacing: 8) {
                        TierTabButton(title: "Free", isSelected: currentTier == "freemium") {
                            currentTier = "freemium"
                        }
                        
                        TierTabButton(title: "Basic", isSelected: currentTier == "basic") {
                            currentTier = "basic"
                        }
                        
                        ZStack {
                            TierTabButton(title: "Pro", isSelected: currentTier == "pro") {
                                currentTier = "pro"
                            }
                            ...
                            VStack(spacing: 0) {
                                ...
                                ScrollView(showsIndicators: false) {
                                    VStack(spacing: 20) {
                                        ...
                                        // Other Features
                                        FeatureRow(icon: "👚", color: Color(hex: "7900FF"), title: "Wardrobe Limit", value: wardrobeText, progress: wardrobeWidth)
                                        FeatureRow(icon: "🪄", color: Color(hex: "00BFFF"), title: "Virtual Try-On", value: tryonText, progress: tryonWidth)
                                        FeatureRow(icon: "🔍", color: Color(hex: "5A00CC"), title: "Clothing Analysis", value: analysisText, progress: analysisWidth)
                                        FeatureRow(icon: "✨", color: Color(hex: "005F73"), title: "AI Outfit Suggestions", value: stylistText, progress: stylistWidth)
                                    }
                                    .padding(.trailing, 4)
                                }
                                ...
                                Button(action: {
                                    ...
                                    Text(btnText)
                                        .font(.system(size: 14, weight: .bold))
                                        .foregroundColor(currentTier == "freemium" ? Color(hex: "505050") : .white)
                                        .frame(maxWidth: .infinity)
                                        .padding(.vertical, 16)
                                        .background(
                                            Group {
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 12)
                                                .stroke(Color(hex: "E0E0E0"), lineWidth: currentTier == "freemium" ? 1 : 0)
                                        )
